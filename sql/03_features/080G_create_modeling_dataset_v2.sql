...
--
-- Inputs:
--   study_ahf.model_070g_modeling_dataset_v1
--   study_ahf.model_080A_vital_burden_0_12h_v1
--
-- Output:
...
drop table if exists study_ahf.model_080G_modeling_dataset_v2 cascade;

create table study_ahf.model_080G_modeling_dataset_v2 as
select
    g.*,
...
from study_ahf.model_070G_modeling_dataset_v1 g
left join study_ahf.model_080A_vital_burden_0_12h_v1 a
    on g.stay_id = a.stay_id;

create index if not exists idx_model_080g_modeling_dataset_v2_stay
    on study_ahf.model_080G_modeling_dataset_v2 (stay_id);

analyze study_ahf.model_080G_modeling_dataset_v2;
...
select
    'study_ahf.model_080G_modeling_dataset_v2' as table_name,
