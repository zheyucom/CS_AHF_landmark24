...
--
-- Inputs:
--   study_ahf_v4_2.model_070g_modeling_dataset_v1
--   study_ahf_v4_2.model_080A_vital_burden_0_12h_v1
--
-- Output:
--   study_ahf_v4_2.model_080G_modeling_dataset_v2
--
-- Important:
--   080A features are pre-landmark predictors only.
-- ============================================================

drop table if exists study_ahf_v4_2.model_080G_modeling_dataset_v2 cascade;

create table study_ahf_v4_2.model_080G_modeling_dataset_v2 as
select
    g.*,
...
from study_ahf_v4_2.model_070G_modeling_dataset_v1 g
left join study_ahf_v4_2.model_080A_vital_burden_0_12h_v1 a
    on g.stay_id = a.stay_id;

create index if not exists idx_model_080g_modeling_dataset_v2_stay
    on study_ahf_v4_2.model_080G_modeling_dataset_v2 (stay_id);

analyze study_ahf_v4_2.model_080G_modeling_dataset_v2;

insert into study_ahf_v4_2.run_manifest (
    table_name,
    sql_file,
    n_rows,
    n_subjects,
...
select
    'study_ahf_v4_2.model_080G_modeling_dataset_v2' as table_name,
...
from study_ahf_v4_2.model_080G_modeling_dataset_v2;
