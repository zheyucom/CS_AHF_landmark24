...
drop table if exists study_ahf_v4_2.model_080A_vital_burden_0_12h_v1 cascade;

create table study_ahf_v4_2.model_080A_vital_burden_0_12h_v1 as
with base as (
    select
        subject_id,
        hadm_id,
...
create index if not exists idx_model_080a_vital_burden_stay
    on study_ahf_v4_2.model_080A_vital_burden_0_12h_v1 (stay_id);

analyze study_ahf_v4_2.model_080A_vital_burden_0_12h_v1;
...
select
    'study_ahf_v4_2.model_080A_vital_burden_0_12h_v1' as table_name,
...
from study_ahf_v4_2.model_080A_vital_burden_0_12h_v1;
