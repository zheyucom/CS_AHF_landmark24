...
SQL_DIR="$ROOT/sql_v3_2/executable"
RUN_DIR="$ROOT/project_control/runs/20260827_v3_2_index_adm/sql_logs"
...
echo "[OK] v3.2 index-admission pipeline (001-064) completed. Logs in $RUN_DIR"
