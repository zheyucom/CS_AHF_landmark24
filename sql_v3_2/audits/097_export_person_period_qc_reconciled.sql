...
-- File: sql_v3_2/audits/097_export_person_period_qc_reconciled.sql
-- Purpose: QC/export the reconciled person-period v2 table.
-- ============================================================
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/098_QC1_landmark_reconciliation.csv
select
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/098_QC2_exclusion_reasons.csv
select
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/097_QC1_overall.csv
select
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/097_QC2_state_and_terminal_rows.csv
select
    final_state,
    count(distinct stay_id) as n_stays,
    count(*) as n_person_period_rows,
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/097_QC3_event_type.csv
select
    event_type,
    count(distinct stay_id) as n_stays,
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/097_QC4_one_terminal_row_per_stay.csv
with terminal as (
    select
        stay_id,
...
select n_terminal_rows, count(*) as n_stays
from terminal
group by n_terminal_rows
order by n_terminal_rows;
\o

\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/097_QC5_time_and_duration.csv
select
    count(*) as n_rows,
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/reports/097_QC6_sepsis_stratum.csv
select
...
\o project_control/runs/20260827_v3_3_person_period_reconciled/data/097_person_period_v33_v2.csv
select *
from study_ahf_v3_2.model_097_person_period_v33_v2
