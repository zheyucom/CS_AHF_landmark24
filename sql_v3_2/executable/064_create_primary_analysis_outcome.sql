...
drop table if exists study_ahf_v3_2.outcome_064_primary_hd_deterioration_v1 cascade;

create table study_ahf_v3_2.outcome_064_primary_hd_deterioration_v1 as
select
    *,
...
from study_ahf_v3_2.outcome_063C_candidate_hd_outcomes_with_nee_v1
...
from study_ahf_v3_2.outcome_064_primary_hd_deterioration_v1;
...
select
    ...
    'study_ahf_v3_2.outcome_064_primary_hd_deterioration_v1',
    count(*),
