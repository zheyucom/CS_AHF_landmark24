...
drop table if exists study_ahf_v3_2.cohort_061A_ahf_evidence_early_window_12h_v1 cascade;

create table study_ahf_v3_2.cohort_061A_ahf_evidence_early_window_12h_v1 as
with base as (
    select *
...
select
    ...
    -- ========================================================
    -- v3.1 additions: AHF time-availability flags
    -- (1) ahf_retro_confirmed_flag      : HF ICD present in the
    --     final discharge coding (retrospective phenotype anchor;
    --     NEVER a predictor)
    -- (2) ahf_time_confirmed_by_t12_flag: >=1 timestamped AHF
    --     evidence (IV loop eMAR / IV loop Rx / NT-proBNP) inside
    --     [T0-24h, T12); the v3.1 MAIN cohort gate
    -- (3) ahf_pre_icu_confirmed_flag    : timestamped evidence
    --     occurred before T0 (prespecified sensitivity stratum)
    -- ========================================================
    ...
    case when (
        (em.loop_emar_first_charttime_early12 is not null
         and em.loop_emar_first_charttime_early12 < b.intime)
     or (rx.iv_loop_rx_first_starttime_early12 is not null
         and rx.iv_loop_rx_first_starttime_early12 < b.intime)
     or (n.ntprobnp_first_charttime_early12 is not null
         and n.ntprobnp_first_charttime_early12 < b.intime)
...
from study_ahf_v3_2.cohort_061A_ahf_evidence_early_window_12h_v1;
