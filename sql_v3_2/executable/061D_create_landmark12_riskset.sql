...
drop table if exists study_ahf_v3_2.cohort_061D_landmark12_riskset_main_v1 cascade;

create table study_ahf_v3_2.cohort_061D_landmark12_riskset_main_v1 as
select
    *,
...
drop table if exists study_ahf_v3_2.cohort_061D_landmark12_riskset_broad_v1 cascade;

create table study_ahf_v3_2.cohort_061D_landmark12_riskset_broad_v1 as
select
    *,
...
select
    ...
    count(*) as n
from study_ahf_v3_2.cohort_061D_landmark12_riskset_broad_v1;
