...
drop table if exists study_ahf_v3_1.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1 cascade;

create table study_ahf_v3_1.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1 as
select
    *,
...
drop table if exists study_ahf_v3_1.outcome_062B_ahf_noearlysepsis12_post12_future48_sensitivity_v1 cascade;

create table study_ahf_v3_1.outcome_062B_ahf_noearlysepsis12_post12_future48_sensitivity_v1 as
select
    *,
...
from study_ahf_v3_1.outcome_062B_ahf_noearlysepsis12_post12_future48_sensitivity_v1;
...
select
    ...
    'study_ahf_v3_1.outcome_062A_post12_outcome_with_earlysepsis12_v1',
    count(*),
...
select
    ...
    'study_ahf_v3_1.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1',
    count(*),
    count(distinct subject_id),
    count(distinct hadm_id),
    count(distinct stay_id),
