...
drop table if exists study_ahf_v3_1.cohort_020_hf_icd_candidate_v1 cascade;

create table study_ahf_v3_1.cohort_020_hf_icd_candidate_v1 as
with dx_clean as (
    select
        d.subject_id,
        d.hadm_id,
...
from study_ahf_v3_1.cohort_010_adult_first_icu_v1 c
...
with dx_exploded as (
    ...
    left join mimiciv_hosp.d_icd_diagnoses dd
        on d.icd_code = dd.icd_code
       and d.icd_version = dd.icd_version
    inner join study_ahf_v3_1.cohort_020_hf_icd_candidate_v1 c
...
select
    ...
    'study_ahf_v3_1.cohort_020_hf_icd_candidate_v1' as table_name,
    count(*) as n_rows,
    count(distinct subject_id) as n_subjects,
    count(distinct hadm_id) as n_hadm,
    count(distinct stay_id) as n_stay,
