...
drop table if exists study_ahf_v3_1.outcome_064_primary_hd_deterioration_v1 cascade;

create table study_ahf_v3_1.outcome_064_primary_hd_deterioration_v1 as
select
    *,
...
select
    ...
    'study_ahf_v3_1.outcome_064_primary_hd_deterioration_v1',
    count(*),
