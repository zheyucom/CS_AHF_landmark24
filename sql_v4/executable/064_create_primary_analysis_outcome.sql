...
-- Main population:
--   AHF strict 12h
--   + early sepsis clinically present at ICU admission, confirmed by T12
...
drop table if exists study_ahf_v4.outcome_064_primary_hd_deterioration_v1 cascade;

create table study_ahf_v4.outcome_064_primary_hd_deterioration_v1 as
select
    *,
    'ahf_admission_present_sepsis_confirmed_t12_landmark12_future48h'::text as analysis_population,
...
from study_ahf_v4.outcome_064_primary_hd_deterioration_v1;
...
select
    ...
    'study_ahf_v4.outcome_064_primary_hd_deterioration_v1',
    count(*),
    ...
    'Primary analysis cohort and outcome: retrospectively confirmed AHF plus infection suspected before ICU and Sepsis-3 fully confirmed by T12; landmark 12h, future 48h hemodynamic deterioration. Primary outcome includes support initiation, increased agent count, NEE increase >=0.05, or death.'
from study_ahf_v4.outcome_064_primary_hd_deterioration_v1;
