...
drop table if exists study_ahf_v4.model_081A_structured_echo_screen_0_12h_v1 cascade;

create table study_ahf_v4.model_081A_structured_echo_screen_0_12h_v1 as
with base as (
    select
        subject_id,
        hadm_id,
