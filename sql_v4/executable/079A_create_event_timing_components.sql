...
create schema if not exists study_ahf_v4;

drop table if exists study_ahf_v4.audit_079_event_timing_components_v1 cascade;

create table study_ahf_v4.audit_079_event_timing_components_v1 as
with base as (
    select
        b.subject_id,
        b.hadm_id,
    ...
    from study_ahf_v4.model_070G_modeling_dataset_v1 b
),
...
create index if not exists idx_audit_079_event_timing_stay
    on study_ahf_v4.audit_079_event_timing_components_v1 (stay_id);

create index if not exists idx_audit_079_event_timing_event_hour
    on study_ahf_v4.audit_079_event_timing_components_v1 (primary_event_hour_after_landmark);

analyze study_ahf_v4.audit_079_event_timing_components_v1;
...
select
    'study_ahf_v4.audit_079_event_timing_components_v1' as table_name,
...
from study_ahf_v4.audit_079_event_timing_components_v1;
