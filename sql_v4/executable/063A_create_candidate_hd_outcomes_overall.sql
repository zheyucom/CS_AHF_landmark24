...
drop table if exists study_ahf_v4.outcome_063A_candidate_hd_outcomes_overall_v1 cascade;

create table study_ahf_v4.outcome_063A_candidate_hd_outcomes_overall_v1 as
with base as (
    select
        *,
...
final_flags as (
    select
        ...
        b.early_sepsis_admission_present_flag,
        ...
        b.early_sepsis12_first_antibiotic_time,
        b.early_sepsis12_first_culture_time,
