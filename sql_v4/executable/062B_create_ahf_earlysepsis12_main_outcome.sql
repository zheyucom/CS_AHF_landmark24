...
--   AHF + sepsis clinically present at ICU admission and confirmed by T12,
--   12h landmark risk set,
--   12-60h new overt CS outcome.
-- ============================================================

drop table if exists study_ahf_v4.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1 cascade;

create table study_ahf_v4.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1 as
select
    *,
    'ahf_admission_present_sepsis_confirmed_t12_landmark12_future48h'::text as main_analysis_definition
from study_ahf_v4.outcome_062A_post12_outcome_with_earlysepsis12_v1
where early_sepsis_admission_present_flag = 1;


drop table if exists study_ahf_v4.outcome_062B_ahf_noearlysepsis12_post12_future48_sensitivity_v1 cascade;

create table study_ahf_v4.outcome_062B_ahf_noearlysepsis12_post12_future48_sensitivity_v1 as
select
    *,
    'not_admission_present_sepsis_confirmed_t12_landmark12_future48h'::text as sensitivity_definition
from study_ahf_v4.outcome_062A_post12_outcome_with_earlysepsis12_v1
where early_sepsis_admission_present_flag = 0;
...
from study_ahf_v4.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1;
...
from study_ahf_v4.outcome_062B_ahf_noearlysepsis12_post12_future48_sensitivity_v1;




delete from study_ahf_v4.cohort_flow
...
select
    ...
    'study_ahf_v4.outcome_062A_post12_outcome_with_earlysepsis12_v1',
    count(*),
...
select
    ...
    'study_ahf_v4.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1',
    count(*),
    count(distinct subject_id),
    count(distinct hadm_id),
    count(distinct stay_id),
    ...
    'Main cohort: retrospectively confirmed AHF plus infection suspected before ICU and Sepsis-3 fully confirmed by T12; no pre12 overt-CS proxy; prediction window 12-60h.'
from study_ahf_v4.outcome_062B_ahf_earlysepsis12_post12_future48_main_v1;
