...
drop table if exists study_ahf.model_070C_static_clinical_features_v1 cascade;

create table study_ahf.model_070C_static_clinical_features_v1 as
with base as (
    select *
...
from study_ahf.model_070C_static_clinical_features_v1;
