...
drop table if exists study_ahf.model_070D_vitals_0_12h_clean_v1 cascade;

create table study_ahf.model_070D_vitals_0_12h_clean_v1 as
with base as (
    select *
...
from study_ahf.model_070D_vitals_0_12h_clean_v1;
...
select
    ...
    sum(temp_available_flag) as n_temp_available,
    sum(spo2_available_flag) as n_spo2_available
from study_ahf.model_070D_vitals_0_12h_v1
