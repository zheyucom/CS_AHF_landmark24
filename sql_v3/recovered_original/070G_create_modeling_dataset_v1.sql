...
drop table if exists study_ahf.model_070G_modeling_dataset_v1 cascade;

create table study_ahf.model_070G_modeling_dataset_v1 as
select
    -- --------------------------------------------------------
    -- IDs and label
    -- --------------------------------------------------------
...
from study_ahf.model_070A_base_index_v1 b
left join study_ahf.model_070C_static_clinical_features_v1 c
    on b.stay_id = c.stay_id
left join study_ahf.model_070D_vitals_0_12h_clean_v1 d
    on b.stay_id = d.stay_id
left join study_ahf.model_070E_labs_0_12h_v1 e
    on b.stay_id = e.stay_id
left join study_ahf.model_070F_support_0_12h_v1 f
...
from study_ahf.model_070G_modeling_dataset_v1;
