...
drop table if exists study_ahf.cohort_061A_ahf_evidence_early_window_12h_v1 cascade;

create table study_ahf.cohort_061A_ahf_evidence_early_window_12h_v1 as
with base as (
    select *
