...
drop table if exists study_ahf.outcome_063A_candidate_hd_outcomes_overall_v1 cascade;

create table study_ahf.outcome_063A_candidate_hd_outcomes_overall_v1 as
with base as (
    select
        *,
