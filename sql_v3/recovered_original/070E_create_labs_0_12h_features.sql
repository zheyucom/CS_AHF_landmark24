...
drop table if exists study_ahf.model_070E_labs_0_12h_v1 cascade;

create table study_ahf.model_070E_labs_0_12h_v1 as
with base as (
    select *
...
from study_ahf.model_070E_labs_0_12h_v1;
