...
drop table if exists study_ahf.model_070A_base_index_v1 cascade;

create table study_ahf.model_070A_base_index_v1 as
select
    o.subject_id,
    o.hadm_id,
    o.stay_id,
...
from study_ahf.outcome_064_primary_hd_deterioration_v1 o
inner join study_ahf.cohort_061B_ahf_strict_12h_v1 c
...
from study_ahf.model_070A_base_index_v1;
