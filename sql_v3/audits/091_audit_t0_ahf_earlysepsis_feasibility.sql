...
drop table if exists study_ahf_v3.audit_091_t0_evidence_by_stay_v1 cascade;

create table study_ahf_v3.audit_091_t0_evidence_by_stay_v1 as
with base as (
    select
        o.subject_id,
        o.hadm_id,
    ...
    from study_ahf_v3.outcome_063c_candidate_hd_outcomes_with_nee_v1 o
...
drop table if exists study_ahf_v3.audit_091_t0_cohort_feasibility_v1 cascade;

create table study_ahf_v3.audit_091_t0_cohort_feasibility_v1 as
select
    cohort_rule,
...
from (
    ...
    from study_ahf_v3.audit_091_t0_evidence_by_stay_v1
...
select *
from study_ahf_v3.audit_091_t0_cohort_feasibility_v1
order by cohort_rule;
