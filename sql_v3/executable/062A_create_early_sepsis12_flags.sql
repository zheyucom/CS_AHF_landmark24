...
drop table if exists study_ahf_v3.outcome_062A_post12_outcome_with_earlysepsis12_v1 cascade;

create table study_ahf_v3.outcome_062A_post12_outcome_with_earlysepsis12_v1 as
with base as (
    select
        *,
