drop table if exists study_ahf_v3.pipeline_audit;

create table study_ahf_v3.pipeline_audit (
...
begin
    for item in
        ...
        from (values
            ...
            (66, 'outcome_062a_post12_outcome_with_earlysepsis12_v1', 'early_sepsis12_main_flag'),
    ...
    loop
        ...
        execute format(
            'insert into study_ahf_v3.pipeline_audit '
...
delete from study_ahf_v3.run_manifest
where version_tag = 'v3_rebuild_20260824';
...
from study_ahf_v3.pipeline_audit
order by step_order;

select * from study_ahf_v3.pipeline_audit order by step_order;
