...
--
-- Input:
--   study_ahf_v3.outcome_063A_candidate_hd_outcomes_overall_v1
--
-- Main idea:
...
drop table if exists study_ahf_v3.outcome_063C_candidate_hd_outcomes_with_nee_v1 cascade;

create table study_ahf_v3.outcome_063C_candidate_hd_outcomes_with_nee_v1 as
with base as (
    select
        *,
