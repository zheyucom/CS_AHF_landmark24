...
drop table if exists study_ahf_v3.model_070D_vitals_0_12h_clean_v1 cascade;

create table study_ahf_v3.model_070D_vitals_0_12h_clean_v1 as
with base as (
    select *
...
from study_ahf_v3.model_070D_vitals_0_12h_clean_v1;
